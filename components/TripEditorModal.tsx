          ...
          <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                      ...
                      <select name="projectId" value={formData.projectId || ''} onChange={handleChange} className="w-full bg-background-dark/70 border border-gray-600/70 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary/50">
          ...
          <div className="md:col-span-2 space-y-2">
            <label className="block text-[11px] font-semibold uppercase tracking-wide text-gray-300/90 mb-1">{t('tripEditor_form_locations')}</label>
                              ...
                              >
                                  ...
                                  <div className="relative w-full">
                                    <input 
                                      ...
                                      className="w-full bg-background-dark/70 border border-gray-600/70 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary/50 disabled:bg-gray-800 disabled:text-gray-500 disabled:cursor-not-allowed"
                                      autoComplete="off"
                                      title={
                  ...
                  <div>
                      ...
                      <select name="specialOrigin" value={formData.specialOrigin} onChange={handleSpecialOriginChange} className="w-full bg-background-dark/70 border border-gray-600/70 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary/50">
