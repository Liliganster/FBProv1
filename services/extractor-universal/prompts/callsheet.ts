...
2.  **Whitelist de Categorías**: Solo devuelve ubicaciones que pertenezcan a una de las siguientes categorías ('location_type'). Ignora por completo protocolos, políticas, hospitales, teléfonos, contactos y avisos que no sean logísticos.
    *   **FILMING_PRINCIPAL**: Set principal, Drehort, Motiv, Set, Shooting Location
...
3.  **Reglas de Ubicación y Geocodificación**:
    *   **'address' es obligatorio**. Es la dirección original del texto. Si no hay dirección, NO incluyas la ubicación.
...
5.  **Rutas**: Devuelve el array 'rutas' como un array vacío: []. Serán generadas programáticamente después.

6.  **Versión**: El campo 'version' siempre debe ser "parser-crew-1".
